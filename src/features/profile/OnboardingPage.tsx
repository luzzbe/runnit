...
export function OnboardingPage({ onComplete }: OnboardingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-primary-900 flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <p className="text-5xl mb-4">🏃</p>
          <h1 className="text-5xl font-black text-white tracking-tighter">Runnit</h1>
          <p className="text-white/70 mt-2 text-sm">
            Ton coach de progression, pas ton réseau social.
          </p>
        </div>

        <div className="bg-white rounded-3xl shadow-2xl p-6 mx-0">
